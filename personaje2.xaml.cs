...
namespace AhorcdoTEAM1
{
    public partial class personaje2 : ContentPage
    {
        ...
        public personaje2(string nivel)
        {
            InitializeComponent();
        ...
        private void MostrarImagen(int intentos)
        {
            ...
            {
                case 1:
                    nombreImagen = "baseesponja1.png";
                    break;
                case 2:
                    nombreImagen = "baseesponja2.png";
                    break;
                case 3:
                    nombreImagen = "baseesponja3.png";
                    break;
                case 4:
                    nombreImagen = "baseesponja4.png";
                    break;
                case 5:
                    nombreImagen = "baseesponja5.png";
                    break;
                case 6:
                    nombreImagen = "baseesponja6.png";
                    break;
                default:
